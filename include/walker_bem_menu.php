<?php
	...
	class walker_bem_head_menu_top extends Walker_Nav_Menu {
		function __construct( $css_class_prefix ) {
			...
			$this->item_css_class_suffixes = array(
				...
				'parent_item'             => 'header__menu-parent',

				'active_item'             => '-item active--item',
				'active_sub_item'         => '-item active--item',
				'parent_of_active_item'   => '-item active--item',
				'ancestor_of_active_item' => '-item active--item',
